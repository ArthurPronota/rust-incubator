...
- [`Что такое проекция [Pin]? Зачем она нужна? Как она используется?`](#что-такое-структурное-закрепление-когда-его-следует-использовать-и-почему)
...
<h3>Что такое проекция [Pin]? Зачем она нужна? Как она используется?</h3>
