...
- <b>Borrowed(&'a B)<b>: Хранит ссылку на данные. Память не выделяется, данные просто читаются из существующего источника.
- <b>Owned(<B as ToOwned>::Owned)<b>: Хранит данные, которыми владеет сам (например, String или Vec). Память выделена в куче.
