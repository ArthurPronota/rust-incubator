...
- [ ] [4. Backend ecosystem][Step 4] (3 days, after all sub-steps)
    ...
    - [ ] [Шаг 4.2: HTTP-серверы и клиенты][Step 4.2] (1 day)
        ...
        - [Как парадигмы «перераспределения задач» и «поток на ядро» влияют на практическое программирование веб-сервера? Какая из них лучше и когда? Когда этот вопрос (выбор) становится актуальным на практике?][4201]
