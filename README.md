...
- [ ] [Шаг 3: Общая экосистема][Step 3] (2 days, after all sub-steps)
    - [Какие возможности тестирования предлагает Rust и когда их следует использовать? Почему следует придерживаться стиля BDD?](3_ecosystem#какие-возможности-тестирования-предлагает-rust-и-когда-их-следует-использовать-почему-следует-придерживаться-стиля-bdd)
