...
В контексте Cargo (менеджера пакетов Rust) опция -p является сокращением от --package.
...
Пример запуска из корневого директория rust-incubator:
...
- [В чём заключаются ключевые моменты парадигмы параллельного выполнения в рамках модели акторов? Какую пользу она может принести в Rust?](#в-чём-заключаются-ключевые-моменты-парадигмы-параллельного-выполнения-в-рамках-модели-акторов-какую-пользу-она-может-принести-в-rust)
