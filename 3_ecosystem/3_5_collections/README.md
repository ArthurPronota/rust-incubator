...
<a name="q-030502"><h3>Что такое неизменяемые коллекции? Как они работают? Почему не стоит использовать их постоянно? Когда имеет смысл их использовать?</h3></a>
...
<a name="q-030503"><h3>Что такое коллекции одновременного доступа (concurrent)? Как они работают? Почему они лучше, чем явная синхронизация для обычной коллекции?</h3></a>
