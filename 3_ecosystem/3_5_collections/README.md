...
Используйте стандартные Vec, HashMap и BTreeMap в 95% случаев. Переходите на im, только если вам критически важна персистентность (возможность держать в памяти несколько версий данных одновременно) или вы хотите избежать сложных блокировок в многопоточном коде.
