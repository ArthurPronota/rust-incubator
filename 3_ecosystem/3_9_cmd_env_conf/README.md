...
<a name="q-030901"><h3>В чём преимущества строгой типизации конфигурации?</h3></a>
...
<a name="q-030902"><h3>Почему переменные окружения полезны для настройки приложения? В чём их основное назначение?</h3></a>
...
<a name="q-030903"><h3>В чём польза crate `config`? Зачем его использовать, если нельзя просто десериализовать файл в структуры с помощью `serde`?</h3></a>
