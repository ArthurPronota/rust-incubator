...
- `Consumer` — это отдельный поток, который принимает сгенерированную матрицу, подсчитывает сумму всех её элементов и выводит сумму в стандартный поток вывода.
