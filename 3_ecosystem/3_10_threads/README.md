...
<a name="q-031001"><h3>Что такое параллелизм? Что такое конкуренция? Как они связаны друг с другом и чем отличаются?</h3></a>
...
<a name="q-031002"><h3>Как в Rust реализован параллелизм? Какие крейты обычно используются для его применения?</h3></a>
...
<a name="q-031003"><h3>Какие основные способы синхронизации потоков существуют в Rust? Каковы преимущества и недостатки каждого из них? Для чего используется каждый из них?</h3></a>
