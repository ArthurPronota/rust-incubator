...
<a name="q-030601"><h3>Как `serde` достигает своей производительности? Как он моделирует данные и разделяет обязанности?</h3></a>
...
<a name="q-030602"><h3>Когда имеет смысл предпочесть `musli` вместо `serde`?</h3></a>
...
<a name="q-030603"><h3>Что такое десериализация с нулевым копированием? Почему она полезна? Как она работает в `serde`? Как она работает в `rkyv`?</h3></a>
...
<a name="q-030604"><h3>Inlining</h3></a>
