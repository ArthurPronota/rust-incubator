...
- [`Что такое проверка свойств? Как она достигает своих целей?`]()
...
```rust
use proptest::prelude::*;   // Импортирует необходимые макросы и инструменты для генерации случайных данных.
