...
> - нельзя напрямую писать в std::io::stdin вашего собственного процесса (есть обход для linux но его стоит избегать)
>
> Поэтому создаём четыре интегральных теста проверяющих критические места программы.
>
> Эти тестыры расположены в файле tests/integration_test.rs
>
