...
Важное напоминание: Для разработки любого из этих макросов вам понадобятся библиотеки syn (для парсинга кода в дерево `AST` - abstract syntax tree) и quote (для превращения дерева обратно в код).
