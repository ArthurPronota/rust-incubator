...
1. Нет обратных ссылок (Backreferences): Вы не можете написать (abc|def)\1, чтобы найти повторение той же подстроки. Эта функция делает задачу NP-полной и не может быть реализована за линейное время.
