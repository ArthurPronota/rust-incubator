...
3. Отсутствие экспоненциального взрыва: Поскольку пути не перебираются по очереди, Rust неуязвим к атакам типа ReDoS (Regular Expression Denial of Service). Ваша программа не зависнет на «катастрофических» выражениях вроде \(a+\)+$.
