...
<h3>Is it single-threaded or multiple-threaded?</h3>
...
<h3>Is it synchronous or asynchronous?</h3>
...
<h3>What runtime does [Rust] have?</h3>
...
<h3>Does it use a GC (garbage collector)?</h3>
...
Вы можете хранить различные типы, реализующие один и тот же тип, вместе, используя объект-характеристику (Box<dyn Trait> или &dyn Trait). Это обеспечивает динамическую диспетчеризацию во время выполнения.
