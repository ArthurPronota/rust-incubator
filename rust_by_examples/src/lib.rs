...
/// 
/// в параметре ```name = "rust_by_examples"```
/// 
/// Запук тестов из документации: ```cargo test --doc```
/// 
/// Создание документации: ```cargo doc```
/// ```
/// let result = rust_by_examples::my_doc_test_add(2, 3) ;
/// assert_eq!(result, 5);
/// ```
...
/// 
/// В документации видно только: ```let res = rust_by_examples::try_div_2(10, 2)? ;```
///
...
///      let res = rust_by_examples::try_div_2(10, 2)? ;
/// #    Ok(())
/// # }
/// # fn main() {
/// #    try_main().unwrap() ;
